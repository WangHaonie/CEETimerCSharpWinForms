...
## 运行截图
> v3.0.5，Windows 11，1920x1080，125% 缩放
...
+ **恢复默认**：恢复默认颜色
+ **高级选项**：完全自定义各时刻要显示的颜色，在 管理颜色规则 对话框中，你可以右键以弹出菜单来进行添加、编辑 (左键双击列表也行)、删除 (Delete) 颜色规则。
### 工具
...
## 开发环境
Windows 11 Pro x64 (22635.3720)，Visual Studio 2022 (17.10.2)，C# (12.0)，WinForms，.NET Framework 4.7.2
## 开源许可证
