...
namespace CEETimerCSharpWinForms.Modules
{
    public class LaunchManager
    {
        ...
        public const string AppVersionText = $"版本 v{AppVersion} (x64) (于 2024-02-08 编译)";
        ...
        public static void CheckEnv()
        {
            ...
            {
                MessageBox.Show($"{Dll} 没有被指定在 Windows 上运行，或者它包含错误。请尝试使用原始安装介质重新安装程序，或联系你的系统管理员或软件供应商以获取支持。错误状态 0x00000003", $"{CurrentExecutableName} - 损坏的映像", MessageBoxButtons.OK, MessageBoxIcon.Error);
                Environment.Exit(3);
            }
